...
//       selectedDistrict = data.districts
//           .firstWhere((e) =>
//               e.name.toLowerCase() == data.profileData!.district.toLowerCase())
//           .id;
//       selectedPartyDistrict = data.partyDistricts
//           .firstWhere((e) => e.id == data.profileData!.partyDistrict)
//           .id;
...
//     isAllDataAvailable = selectedDistrict != null &&
//         selectedPartyDistrict != null &&
//         selectedBtcConstituency != null &&
//         selectConstituency != null &&
//         selectPrimary != null &&
...
//   }
//
//   void loadFilteredConstituencies() {
//     final data = Provider.of<Repository>(context, listen: false);
//     if (selectedBtcConstituency != null) {
//       listOfConstituencies =
//           data.btcAssemblyConstituencies[selectedBtcConstituency!];
//       filteredAssemblyConstituencies = data.assemblyConstituencies
//           .where((e) =>
//               listOfConstituencies.any((f) => f.assemblyConstituencyId == e.id))
//           .toList();
//       setState(() {});
//     }
//   }
...
//
//     if (selectedBtcConstituency != null) {
//       loadFilteredConstituencies();
//     }
//     if (selectConstituency != null) {
//       loadFilteredDistrictAndParty();
//     }
//   }
//
//   void loadFilteredDistrictAndParty() {
//     AssemblyConstituency? selectedAssemblyObj;
//     try {
//       selectedAssemblyObj = filteredAssemblyConstituencies.firstWhere(
//         (assembly) => assembly.id == selectConstituency,
//       );
//     } catch (e) {
//       debugPrint("Assembly constituency not found: $e");
//       return;
//     }
//
//     if (selectedAssemblyObj == null) {
//       debugPrint("No matching assembly constituency found");
//       return;
//     }
//
//     setState(() {
...
//       try {
//         constituency = listOfConstituencies.firstWhere(
//             (e) => e.assemblyConstituencyId == selectedAssemblyObj!.id);
//       } catch (e) {
//         debugPrint("Constituency not found: $e");
//         return;
//       }
//
//       filteredDistricts = Provider.of<Repository>(context, listen: false)
//           .districts
//           .where((e) => listOfConstituencies.any((f) => f.districtId == e.id))
//           .toList();
//
//       filteredPartyDistricts = Provider.of<Repository>(context, listen: false)
//           .partyDistricts
//           .where(
//               (e) => listOfConstituencies.any((f) => f.partyDistrictId == e.id))
//           .toList();
//
//       filteredPrimary = Provider.of<Repository>(context, listen: false)
//               .btcPrimariesList["${constituency.id}"] ??
//           [];
//     });
//   }
//
...
//                   color: Colors.black,
//                 ),
//                 onChanged: (value) => setState(() => checkDataAvailability()),
//               ),
//             ),
//             SizedBox(height: 1.h),
//             Padding(
